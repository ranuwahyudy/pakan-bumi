  ...
  return (
    <BasicLayout>
      <div className="flex gap-2 items-center text-[#6D6D6D] font-semibold mt-10">
        ...
        <BreadcrumbIcon />
        <Link to="/artikel/food-waste">Bahaya Sampah Makanan</Link>
      </div>
      <img
        src="/foodwaste.png"
      ...
      <article className="font-light">
        ...
        <br />
        <br /> Terdapat dua pendapat dari para ahli terkait produksi sampah
        makanan selama Pandemi Covid-19 berlangsung, yakni (1) ketika terjadi
        krisis, akan ada kecenderungan untuk ‘menabung’ dibandingkan ‘membuang’
        makanan yang mengarah kepada pengurangan sampah makanan, dan (2)
        gangguan yang terjadi akibat pandemi seperti lockdown, keterbatasan
